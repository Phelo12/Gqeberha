...
namespace GqeberhaClinic.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,Description")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,Description")] Feedback feedback)
        {
            if (id != feedback.Id)
            {
                return NotFound();
